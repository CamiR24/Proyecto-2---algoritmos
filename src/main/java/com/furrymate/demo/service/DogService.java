    ...
    public void createPerro(Perro perro, String usuario, String password) {
        ...
        try (Session session = driver.session()) {
            session.writeTransaction(tx -> {
                System.out.println("================================================ LANZADO QUERY PERRO ================================================");

                tx.run("CREATE (p:Perro {nombre: $nombre, usuario: $usuario, antecedentes: $antecedentes, password: $password})",
                    parameters("nombre", perro.getNombre(), "usuario", usuario, "antecedentes", perro.getAntecedentes(), "password", password));

                    System.out.println("================================================ QUERY PERRO CREADO ================================================");

                // Crea y conecta atributos como nodos independientes

                System.out.println("================================================ LANZADO QUERY MATCHES ================================================");
                ...
                System.out.println("================================================ QUERY MATCHES CREADO ================================================");

                System.out.println("================================================ CICLO DE QUERYS ================================================");
                ...
                System.out.println("================================================ PERRO TERMINADO ================================================");
